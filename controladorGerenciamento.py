...
class ControladorGerenciamento:
            ...
            if escolha == '1':
                ...
                while True:
                    ...
                    if resp == 1:
                        ...
                        volume_item = validar_float("Digite o volume da tinta: ")
                        ...
                        quantidade_item = validar_int(input("Quantidade a serem adicionadas: "))
                ...
                funcionario = Funcionario(cpf_funcionario, nome_funcionario, salario_funcionario, cargo_funcionario)
    ...
    def exibirFuncionarios(self):
        ...
        print(f"Número de funcionarios diferentes: {self.banco_de_dados.contagem_itens['funcionarios']}")
